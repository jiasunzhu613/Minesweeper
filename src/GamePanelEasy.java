...
/**
 * GamePanel displaying the easy difficulty for MINEWSWEEPER
 * 
 * @date June 2022
 * @author Jonathan Zhu
 */
public class GamePanelEasy extends GamePanel implements Runnable {
	// Initiate variables
	private Nodes[][] nodes;
	...
	public GamePanelEasy() throws IOException, LineUnavailableException, UnsupportedAudioFileException {
		NODEWIDTH = 72;
	...
	public void paintComponent(Graphics g) {
		...
		if ((gameWon || gameLost) && viewingBoard) {
			...
			g.setFont(new Font("Comic Sans", Font.BOLD, 35));
			g.drawString(GameFrame.getBestTimesString(0), 189 + 200 + 1, 240);
			...
			if (GameFrame.getBestTimesString(0).equals(" ")) {
