...
/**
 * GamePanel displaying the medium difficulty for MINEWSWEEPER
 * 
 * @date June 2022
 * @author Jonathan Zhu
 */
public class GamePanelMedium extends GamePanel implements Runnable {
	// Initiate variables
	private Nodes[][] nodes;
	...
	public GamePanelMedium() throws IOException, LineUnavailableException, UnsupportedAudioFileException {
		NODEWIDTH = 40;
	...
	public void paintComponent(Graphics g) {
		...
		if ((gameWon || gameLost) && viewingBoard) {
			...
			g.setFont(new Font("Comic Sans", Font.BOLD, 35));
			g.drawString(GameFrame.getBestTimesString(1), 189 + 200 + 1, 240);
			...
			if (GameFrame.getBestTimesString(1).equals(" ")) {
